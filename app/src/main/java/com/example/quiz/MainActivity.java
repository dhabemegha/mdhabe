                    ...
                    case 4:
                        ...
                        if (radioButton.getText().equals("False")) {
                            ...
                            Toast.makeText(MainActivity.this,
                                    " Wrong!", Toast.LENGTH_SHORT).show();
                        RatingBar rb = findViewById(R.id.ratingBar);
                        rb.setRating(rightCounter);
                        rb.setVisibility(View.VISIBLE);
                        stop_time=System.currentTimeMillis();
                        quiz_time=(start_time-stop_time)/1000;
                        Log.d("MainActivity.java","Total time taken for quiz"+quiz_time+" Seconds");
                       // System.out.println("Total time taken for quiz"+quiz_time+" Seconds");
                        break;
